...
sudo wget https://github.com/SteavenGamerYT/SteavenBuntu/raw/main/SteavenBuntu/nosnap.pref -P /etc/apt/preferences.d/
sudo wget https://github.com/SteavenGamerYT/SteavenBuntu/raw/main/SteavenBuntu/01-network-manager-all.yaml -P /etc/netplan/
sudo wget https://github.com/SteavenGamerYT/SteavenBuntu/raw/main/SteavenBuntu/os-release -P /etc/
...
wget https://github.com/SteavenGamerYT/SteavenBuntu/raw/main/SteavenBuntu/pop-gnome-shell-theme_5.3.1_all.deb -O ~/pop-shell-theme.deb
...
wget https://github.com/SteavenGamerYT/SteavenBuntu/raw/main/SteavenBuntu/pop-sound-theme_5.3.1_all.deb -O ~/pop-sound-theme.deb
